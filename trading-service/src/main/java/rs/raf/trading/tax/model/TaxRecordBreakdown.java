 ...
 *
 * NAPOMENA (copy-first ekstrakcija, faza 2c): {@code taxRecord} veza je
 * {@code @ManyToOne} ka {@link TaxRecord} — oba entiteta su u istom (tax)
 * paketu trading-service-a, pa veza ostaje JPA relacija (intra-domen).
 */
@Entity
