package rs.raf.trading.option.model;
 ...
 *
 * <p>NAPOMENA (copy-first ekstrakcija, faza 2d-C): {@code stockListing} je
 * jedina JPA relacija — {@link Listing} je u trading-service domenu (kopiran u
 * fazi 2b), pa veza ostaje intra-service FK (bez soft-id konverzije).
 */
@Entity
@Table(name = "options")
@Data
